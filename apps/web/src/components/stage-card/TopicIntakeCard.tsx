        ...
        <form className="nb-intake-form centered" onSubmit={onSubmit}>
          ...
          <label className="nb-field">
            ...
            <input
              ...
              onChange={(e) => onFormChange({ ...form, roundCount: Math.max(1, Math.min(100, Number(e.target.value))) })}
            />
          </label>
          <label className="nb-field">
            <span>{t('experts')}</span>
            <input
              ...
              onChange={(e) => onFormChange({ ...form, expertCount: Math.max(1, Math.min(100, Number(e.target.value))) })}
            />
          </label>
          <label className="nb-field">
